...
const LAYER_LABELS: Record<BoardElement["type"], string> = {
  arrow: "Стрелка", cloud: "Облако", code: "Код", image: "Изображение", diamond: "Ромб", ellipse: "Эллипс", embed: "Встроенная страница", frame: "Фрейм", freedraw: "Карандаш", hexagon: "Шестиугольник", line: "Линия", rectangle: "Прямоугольник", star: "Звезда", text: "Текст", triangle: "Треугольник",
};
