...
const SHORTCUT_GROUPS = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["Enter", "Редактировать выбранный текст / заметку / комментарий"],
      ["Double Click", "Редактировать текст внутри блока"],
      ["Ctrl / Cmd + click", "Открыть ссылку объекта"],
